        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="staticBackdropLabel">You can search by the name of the brand</h1>
              ...
              <form action="{{url('search')}}" method="get">
                <div class="input-group">
                  ...
                  <button type="submit" class="btn btn-outline-secondary">
                    ...
                    <p class="m-0">{{$voiture->prix}} <span class="fs-6">DH/J</span> </p> 
                    <p> type :@if ($voiture->type=="Essence")
                      <i class="bi bi-fuel-pump"></i>
                        
                   @else @if($voiture->type=="Diesel")
